...
<body>
    ...
    <section class="bloc">
        ...
        <div>
            <input type="search" name="search" id="searcby1" placeholder="search by location" onchange="sear1(this.value)">
        </div>
      ...
      function sear1(val) {
         ...
         window.location.href ="http://localhost/college_project/searbuy1.php?sea="+val;  
      }
   </script>
